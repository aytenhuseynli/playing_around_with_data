...
def analyse(comment, client, sid):
  ...
  print(score, magnitude, sentiment, comment)
  return score, magnitude, sentiment['compound'], comment
...
aca_post_files = ['survey-results/aca-post-workshop.results.2019-02-20.csv']
#aca_pre_files = ['survey-results/aca-pre-workshop.results.2019-02-20.csv']
